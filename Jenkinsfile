            ...
            steps {
                dir('/var/lib/jenkins/workspace/deployment/final_project/k8s') {
                    script {
                     ...
                     sh "sed -i 's#PLACEHOLDER_INFRA#${imageTag_infra}#g' infra-flask-deployment.yaml | tee infra-flask-deployment-modified.yaml"
                     sh "sed -i 's#PLACEHOLDER_FLASK#${imageTag_flask}#g' flask-app-deployment.yaml | tee flask-app-deployment-modified.yaml"
